...
public class MedicineListAdapter extends RecyclerView.Adapter<MedicineItemViewHolder>{
    ...
    public void onBindViewHolder(@NonNull MedicineItemViewHolder holder, int position) {
        ...
        holder.medicineBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), MedicineDescription.class);
        ...
        {
            Glide.with(PharmacyMedicines.activity).load(url).into(holder.medicineImage);
        }
        else
        {
            Glide.with(PharmacyMedicines.activity).load(ImageUrl).into(holder.medicineImage);
        }
    }
